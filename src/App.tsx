  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-6 px-4 sm:py-12 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* GitHub 链接 */}
        <a
          href="https://github.com/real-jacket/watermark-tool"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed top-3 right-3 sm:top-4 sm:right-4 z-50 bg-gray-900 hover:bg-gray-700 text-white rounded-full p-2 sm:p-2.5 shadow-md hover:shadow-lg transition-all duration-200 group"
        ...
        >
          ...
          {/* Tooltip */}
          <span className="absolute right-full mr-2 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-gray-900 text-white text-xs rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none shadow-lg">
            喜欢的话给个 star ⭐
